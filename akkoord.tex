...
\newrobustcmd{\akkoord}[3][I] {
  ...
  \foreach \x/\y/\z [count=\i] in {#2} {
    \ifcsdef{@barHighSnare@\y} {
      \draw[thick] (\csuse{@barLowSnare@\y}-1,\csuse{@barLowFret@\y-1}) to[out=-20, in=-160] (\csuse{@barHighSnare@\y}-1,\csuse{@barHighFret@\y}-1); % Note: because yscale -1 the angles must be turned 180 (-20 and -160)
    }
